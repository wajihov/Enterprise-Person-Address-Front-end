                ...
                path: 'ui', children: [
                    ...
                    // Forms
                    {
                        path: 'forms', children: [
                            ...
                            { path: "persons", loadChildren: () => import('app/modules/admin/ui/forms/wizards/persons/persons.module').then(m => m.PersonsModule) },
                            { path: "enterprises", loadChildren: () => import('app/modules/admin/ui/forms/enterprises/enterprise-module.module').then(m => m.EnterpriseModuleModule) }
                        ]
