        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    ...
                    {
                        id: 'user-interface.forms.persons',
                        title: 'Persons',
                        type: 'basic',
                        link: '/ui/forms/persons'
                    } *//* ,
                    {
                        id: 'user-interface.forms.enterprise',
                        title: 'Enterprises',
                        type: 'basic',
                        link: '/ui/forms/enterprises'
                    } */
                ]
            },

            {
                id: 'user-interface.forms.enterprises',
                title: 'Enterprises',
                type: 'collapsable',
                icon: 'heroicons_outline:pencil-alt',
                children: [
                    {
                        ...
                        type: 'basic',
                        link: '/ui/enterprises/create-enterprise'
                    }/* ,
                    {
                        id: 'user-interface.forms.enterprises',
                        title: 'Get Enterprise',
                        type: 'basic',
                        link: '/ui/enterprises/getEnterprise'
                    } */,
                    {
                        id: 'user-interface.forms.enterprises',
                        title: 'All Enterprises',
                        type: 'basic',
                        link: '/ui/enterprises/allEnterprise'
                    } 
                ]
            },
            {
